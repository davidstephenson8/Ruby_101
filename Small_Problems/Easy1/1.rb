...
-  Output: A string to the screen as many times as the integer indicates
---
...
stated?
**Implicit Requirements: If a negative integer is given, we don't need to put anything. 
---
Some questions to ask the interviewer (or perhaps yourself) to better understand
the problem.
**Clarifying Questions:**
1. What methods do I know what can iterate through this? 
2. 
3. 
---
...
_Your Edge Cases:_
-  Example 4
  -  Inputs: 234234690283434, "String"
  -  Output: String that many times

  Example 5
    Inputs: -7, "string"
    Outputs: "Please enter a positive integer"
---
Data Structure
--------------
...
I plan to use Ruby to write this up. I don't think I need special data structures for this method,
I think I'll be able to use the parameters in the method without making any additional variables
---
Algorithm
---------
